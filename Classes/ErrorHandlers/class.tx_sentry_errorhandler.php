...
/**
 * This class contains a error handler, which is compatible with 4.x. It replaces
...
class tx_sentry_errorhandler implements t3lib_error_ErrorHandlerInterface {
	...
	public function __construct($errorHandlerErrors) {
		...
		if ($extConf['passErrorsToTypo3']) {
			...
			$this->typo3ErrorHandler = t3lib_div::makeInstance(self::$oldErrorHandlerClassName, $errorHandlerErrors);
